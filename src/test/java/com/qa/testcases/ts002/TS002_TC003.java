...
public class TS002_TC003 extends ReportUtil{
	...
	@Test(description = "Verify that user gets an error message as 'This is required' under Password' textbox provided enters valid value in email textbox leaving password textbox as blank followed by click on Sign In button", groups = {
			"Smoke", "Functional" })
	public void TS002_TC003() throws Exception {
		...
		Map<String, String> TestData = XLUtils.getDataForTest("TS002_TC003", "Sheet2");
