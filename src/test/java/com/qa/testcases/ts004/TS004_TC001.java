...
public class TS004_TC001 extends ReportUtil {
	...
	@Test(description = "Ensure that the search textbox is present on below mentioned pages post login: -" + "Home Page"
			...
			+ "Shopping Cart page" + "My Account page" + "My Wishlist page", groups = { "Regression", "Sanity" })
	public void TS004_TC001() throws Exception {
		...
		// Get data of Sheet4
		Map<String, String> TestData_Sheet4 = XLUtils.getDataForTest("TS004_TC001", "Sheet4");
		...
		/* User adds any element from What's New page in order to make traversal to cart possible */
